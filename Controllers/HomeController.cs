...
namespace LibraryApplication.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                books = db.Books.OrderBy(x => x.Book_U).Skip((pageNum - 1) * listCount).Take(listCount).ToList();
            ...
            else
            {
                ...
                books = books.OrderBy(x => x.Book_U).Skip((pageNum - 1) * listCount).Take(listCount).ToList();
            }
